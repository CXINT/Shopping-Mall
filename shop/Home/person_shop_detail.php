...
<div class="nav">
    ...
    <h2><b></b>我的评价</h2>
    <a href="./show_appraise.php" class="share"><b></b>查看已买宝贝评价</a>    
</div>
...
<h1>
    <a href="./meizhuang/index_meizhuang.php" target="_blank">我还想继续购物</a>
    我的订单
</h1>
      ...
      $res = mysqli_query($link, $sql);
        if ($res && mysqli_num_rows($res) > 0) {
         while ($row = mysqli_fetch_assoc($res)) {
            ...
            <td>
                <a href='action.php?a=del_Order&oid={$row['oid']}'>删除</a>
                <a href='appraise.php?&order_status=$status&goodsname={$row['name']}&goodspic={$row['pic']}&oid={$row['oid']}'>去评价</a>
            </td>
        </tr>";
    }
} else {
    echo "<tr><td colspan='9'><h2>暂无数据</h2></td></tr>";
}
